...
@section('main-sec')
    <section class="home-section">
        <div class="home-content">
            ...
            <span class="text">Kelola Karya Ilmiah</span>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('/admin/karya-ilmiah/store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="judul" id="judul"
                                    class="form-control @error('judul') is-invalid body @enderror" placeholder="" autofocus
                                    required>
                            </div>
                            <div class="mb-3">
            ...
            <div class="modal fade" id="editModal-{{ $data->id }}" tabindex="-1" aria-labelledby="editModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/admin/karya-ilmiah/edit/' . $data->id) }}" method="post"
            ...
            <script>
                $('.delete').click(function() {
                    ...
                    swal({
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                window.location = "/admin/karya-ilmiah/delete/" + buku_id + ""
