        ...
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="content">
                    ...
                    <h1 class="text-judul-profil mt-4 lh-md">Visi-Misi<br>Perpustakaan MAN  1 Yogyakarta</h1>
                    ...
                    <div class="profil-list col-md-20 animate-box">
                        ...
                        <p>"Menjadi sumber ilmu pengetahuan dan penunjang pendidikan untuk melejitkan jiwa mencapai ULIL ALBAB"
                        </p>
                        <h6>MISI 
                        </h6>
                        
                            <ol>
                                    <li>Memberikan layanan prima dengan senyum, salam, dan sapa </li>
                                    <li>Memberi inspirasi karakter positif yang melejitkan jiwa </li>
                                    <li>Menumbuhkan minat dan budaya baca</li>
                                    <li>Meningkatkan akses sumber belajar yang efektif, cepat, dan tepat</li>
                                    <li>Memperluas wawasan IMTAQ dan IPTEK</li>
                            </ol>
                    </div>
                </div>
                {{-- content profil --}}
