...
@section('main-sec')
    ...
    <section class="py-5">
        ...
        <div class="container-search ms-5 mx-4 mt-5">
            ...
            <div class="container">
                <div class="row m-2">
                    <form action="{{ url('/karya-publikasi/search') }}" method="GET" class="col-auto">
        ...
        <div class="container px-4 px-lg-5 ">
            <br>
            <h1>Karya Tulis Terpublikasi</h1>
            <br>
                ...
                @forelse ($karyailmiah as $item)
                    <div class="col mb-4"><a href="">
                            <div class="card h-100">
                                <!-- Product image--><a href="{{ url('/karya-publikasi/' . $item->slug) }}">
                                    <div class="image_3">
                                ...
                                <div class="card-body pt-"3>
                                    <a style="text-decoration:none" href="{{ url('/karya-publikasi/' . $item->slug) }}">
        ...
        @empty
            <div class="col-md-12 p-2 text-center">
                <h4>Karya Tulis Terpublikasi Tidak Ditemukan!</h4>
            </div>
            @endforelse
    </section>
    <div class="d-flex">
