...
@section('main-sec')
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-2 mt-1">
            <a href="/katalog" class="buttonback" > <img class="back-katalog mt-5 " src="{{ URL::asset('images/previous.png') }}"alt=""> </a>
            <div class="container py-5">
                <div class="row align-items-top">
                    <div class="col-lg-6 pb-5 pb-lg-0 ">
                        
                        <img class="img-fluid mx-auto d-block" src="{{ asset('uploads/' . $buku->gambar_buku) }}" alt="">
